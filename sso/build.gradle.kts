...
dependencies {
    ...
    implementation("org.apache.cxf:cxf-rt-ws-policy:4.0.3")
    implementation("org.apache.cxf:cxf-rt-ws-security:4.0.3")
    ...
    cxfCodegen("org.apache.cxf:cxf-rt-frontend-jaxws:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-rt-transports-http:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-core:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-tools-common:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-tools-wsdlto-core:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-tools-wsdlto-databinding-jaxb:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-tools-wsdlto-frontend-jaxws:4.0.3")
    cxfCodegen("org.apache.cxf:cxf-tools-wsdlto-frontend-javascript:4.0.3")
}
